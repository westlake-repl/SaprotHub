...
class SaprotBaseModel(AbstractModel):
    ...
    def __init__(self,
        ...
        self.lora_inference = lora_inference
        if use_lora:
    ...
    def _init_lora(self, lora_config_path):
        ...
        if lora_config_path:
            ...
            if self.lora_inference:
                self.model.merge_and_unload()
                print("LoRA model is initialized for inference.")
            else:
                print("Loaded LoRA model is initialized for training.")
